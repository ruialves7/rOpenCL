# Rodinia Benchmarks - Results
The results presented in file rodinia_chart.pdf were based on the following physical hardware (Table 1) and virtual hardware (Table 2):
